...
import 'package:bmi_calculator_app/utils/calculator.dart';
import 'package:bmi_calculator_app/screens/result.dart';
          ...
          children: [
                ...
                children: [
                  Expanded(
                    child: VxBuilder(
                      ...
                      builder: (context, store, status) => ReusableCard(
                          ...
                          children: [
                            ...
                            SliderTheme(
                              data: SliderTheme.of(context).copyWith(
                                ...
                                overlayColor: Colors.deepPurple.shade900,
            ...
            Expanded(
              child: VxBuilder(
                ...
                builder: (context, store, status) => Row(
                  children: [
                    Expanded(
                      child: ReusableCard(
